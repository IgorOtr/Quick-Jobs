...
Route::group(["prefix" => "Admin"], function () {
    ...
    Route::group(["prefix" => "Vagas"], function () {
        ...
        Route::get('/adicionar', function () {return view('admin.add');})->middleware(['auth', 'verified'])->name('show-form-to-create');
    ...
    Route::group(["prefix" => "Candidatos"], function () {
        Route::get('/', function () {return view('admin.candidatos');})->middleware(['auth', 'verified'])->name('candidatos');
        Route::get('/curriculos', function () {return view('admin.curriculos');})->middleware(['auth', 'verified'])->name('curriculos');

        Route::post('/cadastrar', function () {return 'Precisa de auth?';})->name('cadastrar-candidato');
    });
});
